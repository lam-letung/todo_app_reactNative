...
function ToDoScreen() {
    ...
    useEffect(() => {
        const dataTodoListDisplay = dataTodoList.filter(data => data.status === false)
        if (sort !== null) {
            if (sort === 'All') {
    ...
    const handleCheckStatus = (id: string) => {
        ...
        // const newListDisplay = newList.filter(todo => todo.status === false)
        // setDisplayTodoList(newListDisplay)
    }
            ...
            <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.onBackground }]} >
                <View style={[styles.viewInput]}>
                    ...
                    <TouchableOpacity onPress={handleAddTodo} >
                        <MaterialIcons style={styles.iconInput} name="add" size={24} color="white" />
                    </TouchableOpacity>
                </View>
                        ...
                        renderItem={({ item }) => (
                            ...
                            viewType === 'List' ?
                                ...
                                <View style={[styles.viewList]}>
                                    ...
                                    <Link  href={
                                        {pathname: '/(todo)/edit/[id]', params: {id: `${item.id}`}}}>
